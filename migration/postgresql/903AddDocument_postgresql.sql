...
UPDATE C_DocType SET C_DocTypeOrder_ID=126,Updated=TO_TIMESTAMP('2013-09-12 19:22:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000009
;

-- 12/09/2013 07:22:54 PM VET
-- Farming Technical Assistance
UPDATE AD_ClientInfo SET C_UOM_Weight_ID=50001,Updated=TO_TIMESTAMP('2013-09-12 19:22:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Client_ID=11
;

-- 12/09/2013 07:23:30 PM VET
-- Farming Technical Assistance
UPDATE AD_OrgInfo SET M_Warehouse_ID=50002,Updated=TO_TIMESTAMP('2013-09-12 19:23:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Org_ID=50001
;

-- 12/09/2013 07:24:33 PM VET
-- Farming Technical Assistance
INSERT INTO M_ProductPrice (AD_Client_ID,AD_Org_ID,Created,CreatedBy,IsActive,M_PriceList_Version_ID,M_Product_ID,PriceLimit,PriceList,PriceStd,Updated,UpdatedBy) VALUES (11,50001,TO_TIMESTAMP('2013-09-12 19:24:33','YYYY-MM-DD HH24:MI:SS'),100,'Y',103,1000010,4.000000000000,4.000000000000,4.000000000000,TO_TIMESTAMP('2013-09-12 19:24:33','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 12/09/2013 07:36:25 PM VET
-- Farming Technical Assistance
INSERT INTO C_DocType (AD_Client_ID,AD_Org_ID,C_DocType_ID,Created,CreatedBy,DocBaseType,DocumentCopies,GL_Category_ID,HasCharges,HasProforma,IsActive,IsCreateCounter,IsDefault,IsDefaultCounterDoc,IsDocNoControlled,IsIndexed,IsInTransit,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,IsPickQAConfirm,IsPrepareSplitDocument,IsShipConfirm,IsSOTrx,IsSplitWhenDifference,Name,PrintName,Updated,UpdatedBy) VALUES (11,0,1000013,TO_TIMESTAMP('2013-09-12 19:36:25','YYYY-MM-DD HH24:MI:SS'),100,'FTF',1,108,'N','N','Y','Y','N','N','Y','Y','N','N','N','N','Y','N','N','N','Hoja Técnica','Hoja Técnica',TO_TIMESTAMP('2013-09-12 19:36:25','YYYY-MM-DD HH24:MI:SS'),100)
;
