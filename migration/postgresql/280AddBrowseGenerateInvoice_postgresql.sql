...
-- Farming Technical Assistance
UPDATE AD_Browse SET WhereClause='DocStatus IN (''CO'',''CL'') AND C_Invoice_ID IS NULL',Updated=TO_TIMESTAMP('2013-11-03 18:07:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_ID=50028
;

-- Nov 3, 2013 6:11:19 PM VET
-- Farming Technical Assistance
UPDATE AD_Browse SET WhereClause='DocStatus IN (''CO'',''CL'') AND C_Invoice_ID IS NULL AND AvailableAmt>0',Updated=TO_TIMESTAMP('2013-11-03 18:11:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_ID=50028
;

-- Nov 3, 2013 6:17:41 PM VET
-- Farming Technical Assistance
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,196,0,53528,54279,19,52225,'C_DocType_ID',TO_TIMESTAMP('2013-11-03 18:17:40','YYYY-MM-DD HH24:MI:SS'),100,'Document type or rules','ECA02',22,'The Document Type determines document sequence and processing rules','Y','Y','Y','N','Document Type',10,TO_TIMESTAMP('2013-11-03 18:17:40','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Farming Technical Assistance
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,290,0,53528,54280,10,'DocumentNo',TO_TIMESTAMP('2013-11-03 18:18:44','YYYY-MM-DD HH24:MI:SS'),100,'Document sequence number of the document','ECA02',30,'The document number is usually automatically generated by the system and determined by the document type of the document. If the document is not saved, the preliminary number is displayed in "<>".

If the document type of your document has no automatic document sequence defined, the field is empty if you create a new document. This is for documents which usually have an external number (like vendor invoice).  If you leave the field empty, the system will generate a document number for you. The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).','Y','Y','N','N','Document No',20,TO_TIMESTAMP('2013-11-03 18:18:44','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Farming Technical Assistance
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,56068,0,53528,54281,10,'ControlNo',TO_TIMESTAMP('2013-11-03 18:19:44','YYYY-MM-DD HH24:MI:SS'),100,'ECA02',0,'Y','Y','N','N','Control No',30,TO_TIMESTAMP('2013-11-03 18:19:44','YYYY-MM-DD HH24:MI:SS'),100)
;
