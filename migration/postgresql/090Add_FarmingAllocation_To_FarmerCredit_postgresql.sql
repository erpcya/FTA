...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,56332,0,'FarmingAlloc',TO_TIMESTAMP('2013-09-10 11:00:29','YYYY-MM-DD HH24:MI:SS'),100,'Farming Alloction','ECA02','Allocate or deallocate Credit to Farming, while credit is not completed.','Y','Farming Alloction','Farming Alloction',TO_TIMESTAMP('2013-09-10 11:00:29','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Contribution
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,Classname,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES ('1',0,0,53453,'org.spin.process.FamingAllocation',TO_TIMESTAMP('2013-09-10 11:09:30','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','N','N','N','N','Process Farming Allocation','Y',0,0,TO_TIMESTAMP('2013-09-10 11:09:30','YYYY-MM-DD HH24:MI:SS'),100,'FTA_FarmingAllocation')
;
...
-- SFAndroid Contribution
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,67665,56332,0,53453,28,53544,'FarmingAlloc',TO_TIMESTAMP('2013-09-10 11:19:59','YYYY-MM-DD HH24:MI:SS'),100,'Farming Alloction','U',1,'Allocate or deallocate Credit to Farming, while credit is not completed.','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Farming Alloction',0,TO_TIMESTAMP('2013-09-10 11:19:59','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- SFAndroid Contribution
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,67665,69292,0,53721,TO_TIMESTAMP('2013-09-10 11:22:30','YYYY-MM-DD HH24:MI:SS'),100,'Farming Alloction',1,'U','Allocate or deallocate Credit to Farming, while credit is not completed.','Y','Y','Y','N','N','N','N','N','Farming Alloction',TO_TIMESTAMP('2013-09-10 11:22:30','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Contribution
UPDATE AD_Field SET DisplayLogic='@IsCredit@=''Y''',Updated=TO_TIMESTAMP('2013-09-10 11:23:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=69292
;

-- Sep 10, 2013 11:24:01 AM VET
-- SFAndroid Contribution
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2013-09-10 11:24:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=69292
;

-- Sep 10, 2013 11:24:42 AM VET
-- SFAndroid Contribution
UPDATE AD_Element SET Description='Farming Allocation', Name='Farming Allocation', PrintName='Farming Allocation',Updated=TO_TIMESTAMP('2013-09-10 11:24:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56332
;
...
-- Sep 10, 2013 11:24:42 AM VET
-- SFAndroid Contribution
UPDATE AD_PrintFormatItem SET PrintName='Farming Allocation', Name='Farming Allocation' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=56332)
;
...
-- SFAndroid Contribution
UPDATE AD_Column SET EntityType='ECA02',Updated=TO_TIMESTAMP('2013-09-10 11:26:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=67665
;

-- Sep 10, 2013 11:26:28 AM VET
-- SFAndroid Contribution
UPDATE AD_Field SET EntityType='ECA02',Updated=TO_TIMESTAMP('2013-09-10 11:26:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=69292
;
