...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,56478,0,'suggested',TO_TIMESTAMP('2013-10-11 14:04:01','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','suggested','suggested',TO_TIMESTAMP('2013-10-11 14:04:01','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Contribution
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsTranslated,IsUpdateable,Name,Updated,UpdatedBy,Version) VALUES (0,68740,56478,0,20,53617,'suggested',TO_TIMESTAMP('2013-10-11 14:04:01','YYYY-MM-DD HH24:MI:SS'),100,'ECA02',1,'Y','N','N','N','N','N','N','N','N','N','suggested',TO_TIMESTAMP('2013-10-11 14:04:01','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- SFAndroid Contribution
UPDATE AD_Element SET ColumnName='Suggested', Name='Suggested', PrintName='Suggested',Updated=TO_TIMESTAMP('2013-10-11 14:04:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56478
;
...
-- SFAndroid Contribution
UPDATE AD_PrintFormatItem SET PrintName='Suggested', Name='Suggested' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=56478)
;
...
-- SFAndroid Contribution
UPDATE AD_Browse_Field SET IsDisplayed='Y', SeqNo=120,Updated=TO_TIMESTAMP('2013-10-11 14:05:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_Field_ID=53339
;

-- Oct 11, 2013 2:06:14 PM VET
-- SFAndroid Contribution
UPDATE AD_Browse_Field SET DefaultValue='Y', IsDisplayed='N', IsMandatory='Y', IsQueryCriteria='Y',Updated=TO_TIMESTAMP('2013-10-11 14:06:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_Field_ID=53339
;
