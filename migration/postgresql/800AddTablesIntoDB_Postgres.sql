...
CREATE TABLE FTA_CDL_ReportGroup (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, Description VARCHAR(255) DEFAULT NULL , FTA_CDL_ReportGroup_ID NUMERIC(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Name VARCHAR(60) NOT NULL, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT FTA_CDL_ReportGroup_Key PRIMARY KEY (FTA_CDL_ReportGroup_ID))
;

-- Apr 9, 2014 11:01:09 AM CEST
-- Farming Technical Assistance
ALTER TABLE FTA_CDL_ReportLine ADD COLUMN FTA_CDL_ReportGroup_ID NUMERIC(10) DEFAULT NULL 
;

-- Apr 9, 2014 11:21:11 AM CEST
-- Farming Technical Assistance
ALTER TABLE FTA_CDL_ReportGroup ADD COLUMN PrintName VARCHAR(60) DEFAULT NULL 
;

-- Apr 9, 2014 11:44:42 AM CEST
-- Farming Technical Assistance
ALTER TABLE FTA_CDL_ReportLine ADD COLUMN SeqNo NUMERIC(10) DEFAULT NULL 
;
