...
INSERT INTO AD_Message (AD_Client_ID,AD_Message_ID,AD_Org_ID,Created,CreatedBy,EntityType,IsActive,MsgText,MsgType,Updated,UpdatedBy,Value) VALUES (0,53253,0,TO_TIMESTAMP('2013-11-05 17:34:10','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','Document Allocated','M',TO_TIMESTAMP('2013-11-05 17:34:10','YYYY-MM-DD HH24:MI:SS'),100,'DocumentAllocated')
;
...
-- Farming Technical Assistance
UPDATE AD_Message SET MsgText='Document Allocated Remove or Reverse Allocation',Updated=TO_TIMESTAMP('2013-11-05 17:36:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Message_ID=53253
;
...
-- Farming Technical Assistance
UPDATE AD_Browse SET WhereClause='DocStatus IN (''CO'',''CL'') /*AND C_Invoice_ID IS NULL AND AvailableAmt>0*/',Updated=TO_TIMESTAMP('2013-11-06 09:07:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_ID=50028
;
