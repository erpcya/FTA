...
UPDATE AD_Process SET Value='FTA_FarmingAllocation Process',Updated=TO_TIMESTAMP('2013-09-10 12:36:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53453
;

-- Sep 10, 2013 12:47:53 PM VET
-- SFAndroid Contribution
UPDATE AD_Process SET Classname='org.spin.process.FarmingAllocation',Updated=TO_TIMESTAMP('2013-09-10 12:47:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53453
;

-- Sep 10, 2013 3:35:33 PM VET
-- SFAndroid Contribution
UPDATE AD_Process SET Name='Farming Allocation',Updated=TO_TIMESTAMP('2013-09-10 15:35:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53453
;
...
-- SFAndroid Contribution
UPDATE AD_Process SET Description='Farming Allocation/Deallocation', Help='Allocate or Deallocate a Farming from Credit', Name='Farming Allocation/Deallocation',Updated=TO_TIMESTAMP('2013-09-10 15:37:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53453
;
...
And (FTA_Farming.FTA_FarmerCredit_ID Is Null Or FTA_Farming.FTA_FarmerCredit_ID=@FTA_FarmerCredit_ID@)',Updated=TO_TIMESTAMP('2013-09-10 15:44:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52206
;
