...
-- Farming Technical Assistance
UPDATE AD_Ref_List_Trl SET Name='Preparación',Updated=TO_TIMESTAMP('2014-03-19 15:12:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=54392 AND AD_Language='es_VE'
;
