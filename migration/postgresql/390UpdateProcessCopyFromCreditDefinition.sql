...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,2459,0,53560,54511,20,'CopyLines',TO_TIMESTAMP('2014-02-21 08:01:11','YYYY-MM-DD HH24:MI:SS'),100,'Y','ECA02',1,'Y','Y','N','N','Copy Lines',30,TO_TIMESTAMP('2014-02-21 08:01:11','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Farming Technical Assistance
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,57052,0,20,'CopyProduct',TO_TIMESTAMP('2014-02-21 08:02:40','YYYY-MM-DD HH24:MI:SS'),100,'ECA02',1,'Y','Copy Product','Copy Product',TO_TIMESTAMP('2014-02-21 08:02:40','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Farming Technical Assistance
UPDATE AD_Element_Trl SET Name='Copiar Productos',PrintName='Copiar Productos',Updated=TO_TIMESTAMP('2014-02-21 08:03:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57052 AND AD_Language='es_VE'
;

-- Feb 21, 2014 8:03:15 AM VET
-- Farming Technical Assistance
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,57052,0,53560,54512,20,'CopyProduct',TO_TIMESTAMP('2014-02-21 08:03:10','YYYY-MM-DD HH24:MI:SS'),100,'Y','ECA02',1,'Y','Y','N','N','Copy Product',30,TO_TIMESTAMP('2014-02-21 08:03:10','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Farming Technical Assistance
UPDATE AD_Process_Para SET SeqNo=40,Updated=TO_TIMESTAMP('2014-02-21 08:04:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=54512
;

-- Feb 21, 2014 8:41:42 AM VET
-- Farming Technical Assistance
UPDATE AD_Element SET ColumnName='CopyOnlyProduct', Name='Copy Only Product', PrintName='Copy Only Product',Updated=TO_TIMESTAMP('2014-02-21 08:41:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57052
;
...
-- Feb 21, 2014 8:41:42 AM VET
-- Farming Technical Assistance
UPDATE AD_PrintFormatItem SET PrintName='Copy Only Product', Name='Copy Only Product' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=57052)
;
...
-- Farming Technical Assistance
UPDATE AD_Element_Trl SET Name='Copiar Solo Productos',PrintName='Copiar Solo Productos',Updated=TO_TIMESTAMP('2014-02-21 08:41:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57052 AND AD_Language='es_VE'
;

-- Feb 21, 2014 10:02:07 AM VET
-- Farming Technical Assistance
UPDATE AD_Process_Para SET DefaultValue='N',Updated=TO_TIMESTAMP('2014-02-21 10:02:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=54512
;
