...
-- FTA
UPDATE AD_Element_Trl SET Name='Generar Factura',PrintName='Generar Factura',Updated=TO_TIMESTAMP('2014-09-22 10:10:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57457 AND AD_Language='es_MX'
;
