...
-- FTA
UPDATE AD_Element_Trl SET Name='Aplicado',PrintName='Aplicado',Updated=TO_TIMESTAMP('2014-09-22 07:19:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57456 AND AD_Language='es_MX'
;
