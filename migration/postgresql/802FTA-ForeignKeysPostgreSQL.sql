...
ALTER TABLE FTA_RecordWeight ADD CONSTRAINT FK_FTA_RecordWeight_M_ProductionLine FOREIGN KEY (M_ProductionLine_ID)
	...
	ON UPDATE CASCADE 
	ON DELETE RESTRICT;
-- CDL Report Group in CDL Report Line
ALTER TABLE FTA_CDL_ReportLine ADD CONSTRAINT FK_FTA_CDL_ReportLine_FTA_CDL_ReportGroup FOREIGN KEY (FTA_CDL_ReportGroup_ID)
	REFERENCES FTA_CDL_ReportGroup(FTA_CDL_ReportGroup_ID) 
	ON UPDATE CASCADE 
	ON DELETE RESTRICT;
	
	ALTER TABLE FTA_AttributeReportLine ADD CONSTRAINT FK_FTA_AttributeReportLine_FTA_AttributeReport FOREIGN KEY (FTA_AttributeReport_ID)
	REFERENCES FTA_AttributeReport(FTA_AttributeReport_ID) 
	ON UPDATE CASCADE 
	ON DELETE RESTRICT;
	
	ALTER TABLE FTA_AttributeReportLine ADD CONSTRAINT FK_FTA_AttributeReportLine_M_Attribute FOREIGN KEY (M_Attribute_ID)
	REFERENCES M_Attribute(M_Attribute_ID) 
	ON UPDATE CASCADE 
	ON DELETE RESTRICT;

	ALTER TABLE FTA_CD_Category ADD CONSTRAINT FK_FTA_CreditDefinitionCDCategory FOREIGN KEY (FTA_CreditDefinition_ID)
	REFERENCES FTA_CreditDefinition(FTA_CreditDefinition_ID) 
	ON UPDATE CASCADE 
	ON DELETE RESTRICT;

ALTER TABLE FTA_CD_Category ADD CONSTRAINT FK_M_ProductCDCategory FOREIGN KEY (Category_ID)
	REFERENCES M_Product(M_Product_ID) 
	ON UPDATE CASCADE 
	ON DELETE RESTRICT;

ALTER TABLE FTA_CD_Category ADD CONSTRAINT FK_M_LotCDCategory FOREIGN KEY (PlantingCycle_ID)
	REFERENCES M_Lot(M_Lot_ID) 
	ON UPDATE CASCADE 
	ON DELETE RESTRICT;

ALTER TABLE M_InOut ADD CONSTRAINT FK_M_InOutFarmerCredit FOREIGN KEY (FTA_FarmerCredit_ID)
	REFERENCES FTA_FarmerCredit(FTA_FarmerCredit_ID) 
	ON UPDATE CASCADE 
	ON DELETE RESTRICT;