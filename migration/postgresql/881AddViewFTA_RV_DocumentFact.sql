...
(cdl.Amt * CASE WHEN fc.BasedOnEffectiveQuantity = 'Y' THEN f.EffectiveArea ELSE fc.ApprovedQty END
...
fc.BasedOnEffectiveQuantity,f.EffectiveArea
UNION ALL
...
ll.FTA_FarmerLiquidationLine_ID Line_ID, ll.LineNetAmt Amt, 
--(cdl.Amt * fc.ApprovedQty) SO_CreditLimit, 
(cdl.Amt * CASE WHEN fc.BasedOnEffectiveQuantity = 'Y' THEN f.EffectiveArea ELSE fc.ApprovedQty END
