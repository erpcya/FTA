...
INSERT INTO AD_ReportView (AD_Client_ID,AD_Org_ID,AD_ReportView_ID,AD_Table_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy) VALUES (0,0,53085,53653,TO_TIMESTAMP('2013-10-29 11:07:02','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','FTA_RV_TechnicalForm',TO_TIMESTAMP('2013-10-29 11:07:02','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Oct 29, 2013 11:07:25 AM VET
-- Farming Technical Assistance
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_ReportView_ID,CopyFromProcess,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES ('3',0,0,53515,53085,'N',TO_TIMESTAMP('2013-10-29 11:07:22','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','N','N','Y','N','Technical Form','Y',0,0,TO_TIMESTAMP('2013-10-29 11:07:22','YYYY-MM-DD HH24:MI:SS'),100,'FTA_RV_TechnicalForm TechnicalForm')
;
...
-- Farming Technical Assistance
UPDATE AD_Process_Trl SET Name='Hoja Técnica',Updated=TO_TIMESTAMP('2013-10-29 11:08:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53515 AND AD_Language='es_VE'
;

-- Oct 29, 2013 11:09:20 AM VET
-- Farming Technical Assistance
UPDATE AD_Tab SET AD_Process_ID=53515,Updated=TO_TIMESTAMP('2013-10-29 11:09:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53670
;
