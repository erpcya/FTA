...
-- Farming Technical Assistance
UPDATE AD_Element_Trl SET Name='Maneja Programa de Pago',PrintName='Maneja Programa de Pago',Updated=TO_TIMESTAMP('2014-03-27 17:00:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57108 AND AD_Language='es_VE'
;
