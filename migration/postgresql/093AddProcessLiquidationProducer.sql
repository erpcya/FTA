...
-- SFAndroid Contribution
UPDATE AD_Process_Trl SET Name='Liquidación Productor',Description='Liquidación Productor',Updated=TO_TIMESTAMP('2013-09-10 16:16:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53454 AND AD_Language='es_VE'
;
