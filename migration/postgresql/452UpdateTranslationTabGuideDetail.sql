...
UPDATE AD_Table SET Name='Guide Detail',Updated=TO_TIMESTAMP('2014-04-23 16:18:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53652
;
...
-- Farming Technical Assistance
UPDATE AD_Table_Trl SET Name='Detalle de la Guía',Updated=TO_TIMESTAMP('2014-04-23 16:19:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53652 AND AD_Language='es_VE'
;

-- Apr 23, 2014 4:19:47 PM VET
-- Farming Technical Assistance
UPDATE AD_Element SET Name='Guide Detail', PrintName='Guide Detail',Updated=TO_TIMESTAMP('2014-04-23 16:19:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56569
;
...
-- Apr 23, 2014 4:19:48 PM VET
-- Farming Technical Assistance
UPDATE AD_PrintFormatItem SET PrintName='Guide Detail', Name='Guide Detail' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=56569)
;
...
-- Farming Technical Assistance
UPDATE AD_Element_Trl SET Name='Detalle de la Guía',PrintName='Detalle de la Guía',Updated=TO_TIMESTAMP('2014-04-23 16:19:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56569 AND AD_Language='es_VE'
;
...
-- Farming Technical Assistance
UPDATE AD_Tab_Trl SET Name='Detalle de la Guía',Updated=TO_TIMESTAMP('2014-04-23 16:20:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53795 AND AD_Language='es_VE'
;
