...
and
qa.FTA_QualityAnalysis_ID=@FTA_QualityAnalysis_ID@)',TO_TIMESTAMP('2014-01-15 16:46:52','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','M_Products for (Order - Quality Analysis)','S',TO_TIMESTAMP('2014-01-15 16:46:52','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Jan 15, 2014 4:47:56 PM VET
-- Farming Technical Assistance
UPDATE AD_Column SET AD_Val_Rule_ID=52298,Updated=TO_TIMESTAMP('2014-01-15 16:47:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=71278
;
