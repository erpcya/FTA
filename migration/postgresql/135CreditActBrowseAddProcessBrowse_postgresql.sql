...
INSERT INTO AD_Process (AccessLevel,AD_Browse_ID,AD_Client_ID,AD_Org_ID,AD_Process_ID,Classname,CopyFromProcess,Created,CreatedBy,Description,EntityType,Help,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES ('3',50022,0,0,53483,NULL,'N',TO_TIMESTAMP('2013-10-07 16:50:31','YYYY-MM-DD HH24:MI:SS'),100,'Farmer Credit Allocation','ECA02','Allocate Farmer Credit to Act','Y','N','N','N','N','Farmer Credit Allocation','Y',2,2,TO_TIMESTAMP('2013-10-07 16:50:31','YYYY-MM-DD HH24:MI:SS'),100,'FTA_FarmerCreditAllocation Browse')
;
...
-- SFAndroid Contribution
UPDATE AD_Column SET AD_Process_ID=53483,Updated=TO_TIMESTAMP('2013-10-07 16:51:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=68220
;

-- 07-oct-2013 16:54:15 VET
-- SFAndroid Contribution
UPDATE AD_Process SET AD_Browse_ID=NULL,Updated=TO_TIMESTAMP('2013-10-07 16:54:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53482
;
