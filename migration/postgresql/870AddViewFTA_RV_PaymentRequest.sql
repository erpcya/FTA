...
LEFT JOIN C_DocType dt ON (dt.C_DocType_ID = pr.C_DocType_ID)
LEFT JOIN FTA_FarmerCredit fc ON (pr.FTA_FarmerCredit_ID = fc.FTA_FarmerCredit_ID)
LEFT JOIN FTA_Farming fm ON (fm.FTA_FarmerCredit_ID = fc.FTA_FarmerCredit_ID)
LEFT JOIN FTA_FarmDivision fd ON (fd.FTA_FarmDivision_ID = fm.FTA_FarmDivision_ID)
...
--WHERE FTA_PaymentRequest_ID=1001386
