...
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=280,Updated=TO_TIMESTAMP('2000-12-31 20:48:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=73499
;

-- Dec 31, 2000 8:48:04 PM VET
-- Farming Technical Assistance
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=290,Updated=TO_TIMESTAMP('2000-12-31 20:48:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=73498
;

-- Dec 31, 2000 8:48:17 PM VET
-- Farming Technical Assistance
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2000-12-31 20:48:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=73499
;

-- Dec 31, 2000 8:48:21 PM VET
-- Farming Technical Assistance
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2000-12-31 20:48:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=73498
;

-- Dec 31, 2000 9:00:39 PM VET
-- Farming Technical Assistance
UPDATE AD_Val_Rule SET Code='FTA_FarmerCredit.C_BPartner_ID = @C_BPartner_ID@ AND FTA_FarmerCredit.DocStatus = ''CO'' AND EXISTS(SELECT 1   FROM FTA_BillOfExchange bfe WHERE bfe.Status=''S'' AND bfe.DocStatus IN (''CO'',''CL'')) AND Parent_FarmerCredit_ID IS NULL',Updated=TO_TIMESTAMP('2000-12-31 21:00:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52207
;

-- Dec 31, 2000 11:15:44 PM VET
-- Farming Technical Assistance
UPDATE AD_Column SET AD_Reference_ID=29,Updated=TO_TIMESTAMP('2000-12-31 23:15:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=72998
;
...
-- Farming Technical Assistance
UPDATE AD_Message_Trl SET MsgText='Crédito usado es mayor a  monto Aprovado',Updated=TO_TIMESTAMP('2014-06-02 17:00:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Message_ID=53274 AND AD_Language='es_VE'
;
