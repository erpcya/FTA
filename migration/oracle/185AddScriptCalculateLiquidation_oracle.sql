...
-- SFAndroid Contribution
UPDATE AD_Process_Para SET DefaultValue='@#Date@',Updated=TO_DATE('2013-10-23 01:15:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53989
;

-- Oct 23, 2013 1:17:42 AM VET
-- SFAndroid Contribution
INSERT INTO AD_Rule (AD_Client_ID,AD_Org_ID,AD_Rule_ID,Created,CreatedBy,EntityType,EventType,IsActive,Name,RuleType,Script,Updated,UpdatedBy,Value) VALUES (0,0,50019,TO_DATE('2013-10-23 01:17:40','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','P','Y','groovy:Liquidation','S','"BigDecimal payWeight = Env.ZERO;
...
result=payWeight;"',TO_DATE('2013-10-23 01:17:40','YYYY-MM-DD HH24:MI:SS'),100,'groovy:Liquidation')
;
...
result=payWeight;',Updated=TO_DATE('2013-10-23 01:20:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Rule_ID=50019
;

-- Oct 23, 2013 1:21:08 AM VET
-- SFAndroid Contribution
UPDATE AD_Browse_Field SET IsMandatory='Y',Updated=TO_DATE('2013-10-23 01:21:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_Field_ID=53377
;
