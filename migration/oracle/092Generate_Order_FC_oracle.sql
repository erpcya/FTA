...
UPDATE AD_Column SET IsUpdateable='N',Updated=TO_DATE('2013-09-10 09:50:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66694
;

-- Sep 10, 2013 9:53:45 AM VET
-- Farming Technical Assistance
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,52205,'FTA_CreditDefinition.DocStatus = ''CO''',TO_DATE('2013-09-10 09:53:43','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','FTA_CreditDefinition Completed','S',TO_DATE('2013-09-10 09:53:43','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Sep 10, 2013 9:53:55 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET AD_Val_Rule_ID=52205,Updated=TO_DATE('2013-09-10 09:53:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66694
;

-- Sep 10, 2013 9:54:26 AM VET
-- Farming Technical Assistance
UPDATE AD_Field SET IsReadOnly='N',Updated=TO_DATE('2013-09-10 09:54:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=68229
;

-- Sep 10, 2013 9:54:31 AM VET
-- Farming Technical Assistance
UPDATE AD_Field SET IsMandatory='Y',Updated=TO_DATE('2013-09-10 09:54:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=68229
;

-- Sep 10, 2013 9:55:33 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET ReadOnlyLogic='@FTA_CreditDefinition_ID@!0',Updated=TO_DATE('2013-09-10 09:55:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66694
;

-- Sep 10, 2013 9:59:26 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET ReadOnlyLogic='FTA_CreditDefinition_ID!0',Updated=TO_DATE('2013-09-10 09:59:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66694
;

-- Sep 10, 2013 10:00:09 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET ReadOnlyLogic='@FTA_CreditDefinition_ID@!0',Updated=TO_DATE('2013-09-10 10:00:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66694
;

-- Sep 10, 2013 10:00:40 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET ReadOnlyLogic=NULL,Updated=TO_DATE('2013-09-10 10:00:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66694
;

-- Sep 10, 2013 10:02:24 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET DefaultValue='@#Date@',Updated=TO_DATE('2013-09-10 10:02:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=66558
;

-- Sep 10, 2013 10:54:19 AM VET
-- Farming Technical Assistance
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,56331,0,'C_DocTypeOrder_ID',TO_DATE('2013-09-10 10:54:17','YYYY-MM-DD HH24:MI:SS'),100,'Document type used for orders generated from this sales document','ECA02','The Document Type for order indicates the document type that will be used when an invoice is generated from this sales document.  This field will display only when the base document type is Farmer Credit.','Y','Document Type for Order','Doc Type Order',TO_DATE('2013-09-10 10:54:17','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Farming Technical Assistance
UPDATE AD_Element_Trl SET Name='Tipo de Documento para la Orden',PrintName='Tipo de Documento para la Orden',Updated=TO_DATE('2013-09-10 10:54:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56331 AND AD_Language='es_MX'
;

-- Sep 10, 2013 10:55:27 AM VET
-- Farming Technical Assistance
UPDATE AD_Element_Trl SET Description='Tipo del documento usado para Ordenes generadas desde este documento de Crédito',Updated=TO_DATE('2013-09-10 10:55:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56331 AND AD_Language='es_MX'
;

-- Sep 10, 2013 10:56:29 AM VET
-- Farming Technical Assistance
UPDATE AD_Element_Trl SET Help='El Tipo de documento para orden indica el tipo de documento que será usado cuando una orden se genera desde este documento de crédito. Este campo se desplegará solamente cuando el tipo de documento base sea Crédito a Productor',Updated=TO_DATE('2013-09-10 10:56:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56331 AND AD_Language='es_MX'
;

-- Sep 10, 2013 10:57:33 AM VET
-- Farming Technical Assistance
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,67664,56331,0,18,217,206,'C_DocTypeOrder_ID',TO_DATE('2013-09-10 10:57:31','YYYY-MM-DD HH24:MI:SS'),100,'Document type used for orders generated from this sales document','ECA02',10,'The Document Type for order indicates the document type that will be used when an invoice is generated from this sales document.  This field will display only when the base document type is Farmer Credit.','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Document Type for Order',0,TO_DATE('2013-09-10 10:57:31','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Farming Technical Assistance
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,67664,69291,0,167,TO_DATE('2013-09-10 10:58:18','YYYY-MM-DD HH24:MI:SS'),100,'Document type used for orders generated from this sales document',0,'ECA02','The Document Type for order indicates the document type that will be used when an invoice is generated from this sales document.  This field will display only when the base document type is Farmer Credit.','Y','Y','Y','N','N','N','N','N','Document Type for Order',320,0,TO_DATE('2013-09-10 10:58:18','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Farming Technical Assistance
UPDATE AD_Field SET DisplayLogic='@DocBaseType@=''FFC''',Updated=TO_DATE('2013-09-10 10:59:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=69291
;
...
-- Farming Technical Assistance
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2013-09-10 11:02:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=69291
;

-- Sep 10, 2013 11:04:24 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET AD_Reference_Value_ID=290,Updated=TO_DATE('2013-09-10 11:04:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=67664
;

-- Sep 10, 2013 11:08:08 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET AD_Reference_Value_ID=170,Updated=TO_DATE('2013-09-10 11:08:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=67664
;

-- Sep 10, 2013 11:09:47 AM VET
-- Farming Technical Assistance
UPDATE AD_Column SET AD_Val_Rule_ID=133,Updated=TO_DATE('2013-09-10 11:09:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=67664
;
...
-- Farming Technical Assistance
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2013-09-10 11:49:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=68120
;

-- Sep 10, 2013 11:49:43 AM VET
-- Farming Technical Assistance
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2013-09-10 11:49:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=68229
;

-- Sep 10, 2013 11:50:46 AM VET
-- Farming Technical Assistance
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,67666,56084,0,19,259,'FTA_FarmerCredit_ID',TO_DATE('2013-09-10 11:50:40','YYYY-MM-DD HH24:MI:SS'),100,'Farmer Credit or Debts','ECA02',10,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Farmer Credit/Debt',0,TO_DATE('2013-09-10 11:50:40','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Farming Technical Assistance
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,DisplayLogic,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,67666,69293,0,294,TO_DATE('2013-09-10 11:52:15','YYYY-MM-DD HH24:MI:SS'),100,'Farmer Credit or Debts',0,'@FTA_FarmerCredit_ID@!0','ECA02','Y','Y','Y','N','N','N','N','N','Farmer Credit/Debt',680,0,TO_DATE('2013-09-10 11:52:15','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Farming Technical Assistance
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2013-09-10 11:59:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=69293
;

-- Sep 10, 2013 11:59:45 AM VET
-- Farming Technical Assistance
UPDATE AD_Field SET DisplayLogic='@FTA_FarmerCredit_ID@!0', IsReadOnly='Y',Updated=TO_DATE('2013-09-10 11:59:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=69293
;
