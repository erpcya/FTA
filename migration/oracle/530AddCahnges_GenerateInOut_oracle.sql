...
AND NOT EXISTS(SELECT 1 FROM FTA_LoadOrder lo WHERE lo.FTA_EntryTicket_ID = FTA_EntryTicket.FTA_EntryTicket_ID AND lo.DocStatus NOT IN(''VO'', ''RE'',''CL''))',Updated=TO_DATE('2014-11-27 14:01:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52259
;
...
-- FTA
UPDATE AD_Process_Para SET IsMandatory='N',Updated=TO_DATE('2014-11-27 14:03:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=55017
;
...
-- FTA
UPDATE AD_Process_Para SET IsMandatory='N',Updated=TO_DATE('2014-11-27 14:03:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=55018
;

-- Nov 27, 2014 2:08:04 PM CET
-- FTA
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,287,0,53713,55058,17,135,219,'DocAction',TO_DATE('2014-11-27 14:08:01','YYYY-MM-DD HH24:MI:SS'),100,'CO','The targeted status of the document','ECA02',2,'You find the current status in the Document Status field. The options are listed in a popup','Y','Y','Y','N','Document Action',40,TO_DATE('2014-11-27 14:08:01','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- FTA
UPDATE AD_Browse_Field SET IsIdentifier='Y',Updated=TO_DATE('2014-11-27 14:08:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_Field_ID=53952
;
...
-- FTA
UPDATE AD_Browse_Field SET IsOrderBy='Y', SortNo=10,Updated=TO_DATE('2014-11-27 14:15:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_Field_ID=53981
;
