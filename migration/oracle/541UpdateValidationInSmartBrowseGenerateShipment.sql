...
',Updated=TO_DATE('2015-01-14 23:15:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_ID=50043
;
...
)) AND GI.DocStatus = ''CO'' AND GI.OperationType IN (''DFP'',''DBM'')  AND GI.M_InOutLine_ID IS NULL ',Updated=TO_DATE('2015-01-14 23:16:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_ID=50043
;
...
OR (GI.IsImmediateDelivery = ''Y'' AND EXISTS (SELECT 1 FROM FTA_WeightScale WHERE FTA_WeightScale.AD_Org_ID =GI.AD_Org_ID  AND FTA_WeightScale.IsActive = ''Y'') 
)) AND GI.DocStatus = ''CO'' AND GI.OperationType IN (''DFP'',''DBM'')  AND GI.M_InOutLine_ID IS NULL ',Updated=TO_DATE('2015-01-14 23:17:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52408
;
...
',Updated=TO_DATE('2015-01-14 23:21:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52408
;
