 ...
 *
 */
public class MFTAAllocationLine extends X_FTA_AllocationLine {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 591846738839130959L;

	/**
	 * *** Constructor ***
	 * @author <a href="mailto:yamelsenih@gmail.com">Yamel Senih</a> 27/08/2013, 14:41:45
	 * @param ctx
	 * @param FTA_AllocationLine_ID
	 * @param trxName
	 */
	public MFTAAllocationLine(Properties ctx, int FTA_AllocationLine_ID,
			String trxName) {
	 ...
	 * @param trxName
	 */
	public MFTAAllocationLine(Properties ctx, ResultSet rs, String trxName) {
	 ...
	 *	@param parent parent
	 */
	public MFTAAllocationLine (MFTAAllocation parent)
	{
		this (parent.getCtx(), 0, parent.get_TrxName());
		setClientOrg(parent);
		setFTA_Allocation_ID(parent.getFTA_Allocation_ID());
		m_parent = parent;
	 ...
	 */
	public MFTAAllocationLine (MFTAAllocation parent, BigDecimal Amount, 
	...
	/** Allocation Header		*/
	private MFTAAllocation	m_parent = null;
	
	/**
	 * 	Get Parent
	 *	@return parent
	 */
	public MFTAAllocation getParent()
	{
		if (m_parent == null)
			m_parent = new MFTAAllocation (getCtx(), getFTA_Allocation_ID(), get_TrxName());
		return m_parent;
	}	//	getParent
	 ...
	 *	@param parent parent
	 */
	protected void setParent (MFTAAllocation parent)
	{
		m_parent = parent;
	}	//	setParent
	
	/**
	 * 	Get Parent Document Date
	 *	@return date trx
	 */
	...
	protected boolean beforeSave (boolean newRecord)
	{
		if (newRecord && getParent().isComplete()) {
			log.saveError("ParentComplete", Msg.translate(getCtx(), "FTA_AllocationLine"));
			return false;
		}
		if (!newRecord  
	...
	{
		StringBuffer sb = new StringBuffer ("MFTAAllocationLine[");
		sb.append(get_ID());
