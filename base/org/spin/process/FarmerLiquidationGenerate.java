...
public class FarmerLiquidationGenerate extends SvrProcess {
	...
	protected void prepare() {
		...
		sql.append("Select \n "
				...
				+"		    tsb.T_Selection_ID, \n "
				+"		    Max(Case When tsb.ColumnName = 'RWUL_Price' Then tsb.Value_Number Else 0 End) As Price, \n "
				+"		    Max(Case When tsb.ColumnName = 'RWUL_PayWeight' Then tsb.Value_Number Else 0 End) As PayWeight, \n "
